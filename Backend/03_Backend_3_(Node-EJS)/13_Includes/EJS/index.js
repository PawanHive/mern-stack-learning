...
// app.use(express.static(path.join(__dirname, "public")));          // REMEMBER SYNTAX to serve single static folder "public"         ... if there is file inside 'public' folder then it can be accessed automatically by express
app.use(express.static(path.join(__dirname, "public/css")));
app.use(express.static(path.join(__dirname, "public/js")));             // REMEMBER SYNTAX to serve multiple static folders "public/css" & "public/js"      .... but "/public/css" is wrong practice...there should no '/' before 'public' folder
