...
let port = 7000;                                // Port number for the server
...
app.get("/posts/:id", (req, res) => {               // request URL: http://localhost:7000/posts/1a  or  http://localhost:7000/posts/2b  or  http://localhost:7000/posts/3c
