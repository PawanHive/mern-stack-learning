...
let port = 1100;                                // Port number for the server

const path = require("path");                   // Import path module to work with file paths
const { v4: uuidv4 } = require("uuid");         // Import UUID 

const methodOverride = require("method-override");      // Import methodOverride modules
app.use(methodOverride("_method"))                      //This tells Express to look for _method in the request.
