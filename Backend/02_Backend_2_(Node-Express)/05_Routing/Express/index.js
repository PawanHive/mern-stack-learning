...
app.get("/", (req, res) => {
  // route defined as "/" ... known as root path      // http://localhost:5000/
  console.log("root");
  res.send("you contacted root path");
});

app.get("/apple", (req, res) => {
  // route defined as "/apple" path     // http://localhost:5000/apple
  console.log("apple");
  res.send("you contacted apple path");
});

app.get("/orange", (req, res) => {
  // route defined as "/orange" path     // http://localhost:5000/orange
  console.log("orange");
